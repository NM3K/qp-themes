                        ...
                        <td valign="top" >
                          <div id="addQRightDivID" class="createQMain">  
                            <div class="createQContainer">
                              ...
                              <?php include('partials/lb_content_1.php'); ?>
